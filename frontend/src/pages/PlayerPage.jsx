    ...
    <div className="fixed inset-0 bg-black flex flex-col">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center justify-between px-4 py-3
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Mute toggle — always visible so user can unmute */}
          <button
            onClick={unmute}
          ...
          >
            {muted ? (
              ...
              <>
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                    d="M15.536 8.464a5 5 0 010 7.072M12 6v12m-3.536-9.536A5 5 0 005.5 12a5 5 0 002.964 4.536M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" />
                </svg>
                Audio on
              </>
            )}
      ...
      {/* Waiting overlay when not yet live */}
      {!isLive && (
